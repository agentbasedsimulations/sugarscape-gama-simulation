...
experiment simulation type: gui {
	...
	output {
		...
		datalist (distribution_of(ant collect each.energy,20,ant min_of each.energy,ant max_of each.energy) at "legend") 
		    value:(distribution_of(ant collect each.energy,20,0,100) at "values");		
	    }
	}
